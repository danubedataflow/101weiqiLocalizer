...
const textReplacements = {
    ...
    "欢迎关注101围棋公众号，无需注册，直接通过微信就可以做题" : "Welcome to follow the 101weiqi official account. You can do the exercises directly through WeChat without registration.",
    "棋友解答由分享人判定，并由分享人分派奖励给其中一位棋友。" : "The players’ answers are judged by the sharer, and the sharer distributes a reward to one of the players.",
    ...
    "生成成长足迹消耗的系统时间较多，请等待2分钟左右。" : "Generating growth footprints consumes a lot of system time, please wait about 2 minutes.",
    ...
    "精品题库（9万题，人工筛选，逐题审核，质量保证）" : "Excellent problem collection (90,000 questions, manual screening, question-by-question review, quality assurance)",
    "公开题库（包含101围棋所有入库题目，未经筛选）" : "Public problem collection (contains all 101weiqi problems, without screening)",
    "每道题目的做题次数，达到这个次数没有做对则判错" : "The number of attempts for each problem. If this number is reached, it will be judged wrong.",
    "棋友完成棋书作业后，将在此显示本书做题数据统计" : "After Go players complete their book homework, the statistics of the book's problem solving data will be displayed here",
    ...
    "请求其他棋友审核，将花费30围豆" : "Requesting a review from other players costs 30 weidou",
    "普通会员只能免费生成一次成长足迹" : "Ordinary members can only generate growth footprints once for free",
    "你的用户名和密码不符，请再试一次" : "Your username and password do not match; please try again",
    "仅仅本教室/棋社的棋友能提交解答" : "Only players in this classroom/club can submit answers",
    ...
    "大橋流パワーアップ詰碁400" : "Oohashi-style Power Up Tsumego 400",
    ...
    "非会员只能选择公开题库" : "Non-members can only choose the public problem collection",
    "银卡会员以上没有限制。" : "There is no limit for Silver Card members and above.",
    "请按照顺序在棋盘上落子" : "Please play the moves in order",
    "请勾选下列棋书进行挑选" : "Please check the boxes below to select books",
    ...
    "所有棋友都能提交解答" : "All players can submit answers",
    ...
    "依据棋友当前水平设置" : "set according to current level",
    "以后每次收取50围豆" : "50 beans will be charged each time thereafter",
    "一按难度顺序查阅本书" : "Read this book in order of difficulty",
    "贡献较多的棋友名单" : "Top contributors",
    "请至少选择一本棋书" : "Please select at least one book",
    "请直接在棋盘上落子" : "Please place the stones on the board",
    ...
    "分享时带上本题答案" : "Please bring the answer to this problem when sharing",
    "做一题/签到 设置" : "Doing problem settings",
    "会显示月度成长足迹" : "the monthly growth footprint will be displayed",
    "之后，才能开始做题" : "After that, you can start doing the questions",
    "一次生成的题目数量" : "Number of problems generated at a time",
    ...
    "显示本题难度级别" : "Show the difficulty level of this problem",
    ...
    "生きるか死ぬか" : "Live or die",
    "没有检索到数据" : "No data retrieved",
    "死活训练初级篇" : "Life-and-death training beginner drill",
    ...
    "我的上课记录" : "My lesson records",
    "我收藏的题目" : "Bookmarked problems",
    "我收藏的棋书" : "My favorite book",
    ...
    "将会持续统计" : "statistics will be kept",
    "官子题目列表" : "Endgame list",
    ...
    "边上的死活" : "Life-and-death on the side",
    "變相中国流" : "Mini-Chinese opening",
    "變形中國流" : "Mini-Chinese opening",
    "角隅的死活" : "Life-and-death in the corner",
    "角部的特性" : "corner characteristics",
    "藤泽库之助" : "Fujisawa Hosai",
    "芝野龍之介" : "Shibano Ryunosuke",
    "继续做一题" : "Continue doing problems",
    ...
    "死活的应用" : "Application of life-and-death",
    ...
    "挂上免战牌" : "Hang up the no-fight sign",
    ...
    "取消免战牌" : "Cancel the no-fight sign",
    "入腹争正面" : "Enter the belly to fight for the front",
    "做一题设置" : "Problem setup",
    "作业本名称" : "Workbook name",
    ...
    "在选点中" : "among the selected points",
    "围豆奖励" : "Beidou rewards",
    "围棋闯关" : "Exam",
    "围棋裁判" : "Go referee",
    ...
    "刀板五" : "bulky five",
    "刀把五" : "bulky five",
    "六目型" : "Six-space shapes",
    "公开赛" : "Open",
    "公众号" : "Public account",
    "八目型" : "Eight-space shapes",
...
function replaceInString(s) {
    ...
    s = s.replaceAll(re_from_to, (match, n) => `From ${n} to`)
    s = s.replaceAll(re_results, (match, n) => `${n} results`)
